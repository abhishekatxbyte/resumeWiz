...
//                             <h4>Select File here</h4>
//                         </header>
//                         <p>File Supported: PDF,JPG,PNG,JPEG</p>

//                         <input type="file" accept=".pdf,.png,.jpg,.jpeg" id="fileID" style={{ display: "none" }} onChange={handleFileChange} ref={inputRef} />
//                         <button className="btn" onClick={() => inputRef.current.click()}>Choose File</button>
//                     </div>
//                 </div>
//             </div>
